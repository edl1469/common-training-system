...
$html .= "<p>Unfortunately, our web application has experienced difficulties that "
        ."it cannot overcome. Please return later to conduct your business.</p>";
$html .= "<p>Please report the problem, if you are willing, to: "
        ."<a href='mailto:wdc@csulb.edu?subject=".htmlentities(NAME_GROUP)
        ."&body=Application%20Error:%20{$type}'>wdc@csulb.edu</a> ";
