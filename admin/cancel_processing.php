...
if ($mysqli->connect_error) {
  ...
  // Pull course information.
      ...
      $can_date = $row['TDate'];
      $can_desc = "<p>Your registration has been cancelled for the following course: </p><p><strong>".$row['Description']."</strong></p>";
  ...
  // Send cancellation confirmation email.
      ...
      $msg .="<p>The cancellation was completed by the Training Administrator for this course. If you have any questions please contact the appropriate training administrator.</p>";
