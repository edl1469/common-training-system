...
if ($mysqli->connect_error) {
  ...
  // Pull course information.
      ...
      $can_date = $row['TDate'];
      $can_desc = "<p>A training session has been cancelled for the following course: </p><p><strong>".$row['Description']."</strong></p>";
  ...
  // Send cancellation confirmation email.
      ...
      $msg .= "<p>The cancellation is for: <strong>" .$reg_first. "&nbsp;" .$reg_last. "</strong></p>";
      $msg .="<p>The cancellation was completed by the Training Administrator for this course. If you have any questions please contact the appropriate training adminsitrator.</p>";
      $msg .= "<p>Course Details: <ul><li>Date: " . $can_date. "</li><li> StartTime: ". $can_start . "</li><li> EndTime:" . $can_end." </li><li>Location: ".$can_loc. "</li></ul></p>";

      $to = MAIL_GROUP. "," .$reg_email;


      mail($to, 'Training Cancellation Notification', $msg, $headers);


  header("Location: cancel.php?success=1&tid={$reg_tid}");
