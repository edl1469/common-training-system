...
if ($mysqli->connect_error) {
  ...
  $html .= "<form method='post' name='signup_form' action='batch_enroll_processing.php' onsubmit='return validateForm();'>\n";
  ...
  if ($crs_seats > 0) {
    ...
    $html .= "<p>Please make sure the file is formatted correctly to include all required fields.</p>
        <fieldset><legend>Batch File Upload</legend>
        <div>
            <p><label for='filename'>First Name</label> <input type='text' name='fname' /></p>
