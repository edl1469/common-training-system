...
if ($mysqli->connect_error) {
  ...
  $message = "Please remember that you are enrolled in a training course, titled '{$crs_name}', to be held at {$crs_start} on {$crs_datef} in {$crs_loc}.";
  ...
  // ########## Write content
  $page['content'] = $html;
  $page['css'] = "<link href='".URL_COMMON."/css/remind.css' rel='stylesheet' type='text/css' />\n";
