...
if ($mysqli->connect_error) {
    ...
    if ($crs_wait) {
        $msg = "Thank you for your registration. You were put on a wait-list for *{$crs_name}* on *{$crs_date}*. "
                ."You will be contacted before the event if a seat becomes available. Have a great day! ";
    } else {
        $msg = $email_msg;
    }
    $to = "{$reg_email}";
